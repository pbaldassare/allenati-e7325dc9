-- Prima rimuovere il vincolo NOT NULL per first_name e last_name
...
-- Gestire i nomi generici "Nome Cognome" - ora possiamo settarli a NULL
UPDATE public.profiles 
SET 
  first_name = NULL,
  last_name = NULL
...
DROP TRIGGER IF EXISTS validate_profile_names_trigger ON public.profiles;
