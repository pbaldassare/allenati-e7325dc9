...
BEGIN
    ...
    -- Get count of moved courses
    GET DIAGNOSTICS courses_moved = ROW_COUNT;
    
    -- Log the number of courses moved
    RAISE NOTICE 'Moved % courses to Muay Thai category', courses_moved;
END $$;
...
-- Step 5: Verify the changes and show results
SELECT 
    name,
    description,
    color_hex,
