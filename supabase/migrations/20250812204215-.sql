-- Update handle_new_user to store guardian info for minors into profile emergency contacts
...
BEGIN
  ...
  -- Create profile automatically, including phone and emergency contacts for minors
