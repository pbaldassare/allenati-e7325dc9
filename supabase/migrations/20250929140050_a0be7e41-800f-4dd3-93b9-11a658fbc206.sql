-- Step 1: Fix the handle_new_user function by removing the manual gym_credits insertion
-- This prevents double crediting (manual insertion + trigger)
...
BEGIN
  ...
  ELSE
    ...
    -- REMOVED: Manual gym_credits insertion - let the trigger handle it
    -- The update_gym_credits() trigger will automatically manage gym_credits based on transactions
  END IF;
...
-- Step 2: Recalculate all gym credits to fix existing duplications
SELECT recalculate_all_gym_credits_fixed();