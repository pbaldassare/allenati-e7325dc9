...
BEGIN
  ...
  FOR missing_record IN 
    SELECT DISTINCT ugm.user_id, ugm.gym_id
  ...
  LOOP
    ...
    VALUES (missing_record.user_id, 'instructor', true)
    ...
    VALUES (_instructor_id, missing_record.gym_id, true, true)
