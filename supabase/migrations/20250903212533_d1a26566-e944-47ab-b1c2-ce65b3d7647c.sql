-- Drop the existing constraint/index and create a new one
DROP INDEX IF EXISTS unique_active_subscription_per_user_plan;
...
DROP TRIGGER IF EXISTS prevent_duplicate_subscriptions_trigger ON public.user_subscriptions;
