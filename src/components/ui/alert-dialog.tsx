...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse gap-2 sm:flex-row sm:justify-end sm:gap-2 sm:space-x-0 [&>button]:w-full sm:[&>button]:w-auto",
      className
    )}
    {...props}
  />
