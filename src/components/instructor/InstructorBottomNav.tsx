import { Home, BookOpen, Calendar, Users, Menu } from "lucide-react";
...
const tabs = [
  { id: "dashboard", icon: Home, label: "Home", path: "/instructor" },
...
export const InstructorBottomNav = () => {
  ...
  const isActive = (path: string) =>
    path === "/instructor" ? pathname === "/instructor" : pathname.startsWith(path);
