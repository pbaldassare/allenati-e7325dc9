...
const initializeFakeData = () => {
  ...
  const FAKE_COURSES: Course[] = [
    // Monday
    {
      ...
      schedule: [{ dayOfWeek: 1, time: '19:00' }],
      price: 30,
    ...
    },
    {
      ...
      schedule: [{ dayOfWeek: 1, time: '20:30' }],
      price: 25,
      image: '/api/placeholder/300/200',
      rating: 4.7,
    ...
    },
    {
      ...
      schedule: [{ dayOfWeek: 2, time: '10:00' }],
      price: 20,
      image: '/api/placeholder/300/200',
      rating: 4.6,
    ...
    },
    {
      ...
      schedule: [{ dayOfWeek: 3, time: '20:15' }],
      price: 30,
      image: '/api/placeholder/300/200',
      rating: 4.8,
    ...
    // Thursday
    {
      ...
      maxParticipants: 10,
      currentParticipants: 8,
      schedule: [{ dayOfWeek: 4, time: '19:30' }],
      price: 35,
      image: '/api/placeholder/300/200',
      rating: 4.9,
    ...
    // Friday
    {
      ...
      schedule: [{ dayOfWeek: 5, time: '18:00' }],
      price: 35,
      image: '/api/placeholder/300/200',
      rating: 4.8,
    ...
    },
    {
      ...
      schedule: [{ dayOfWeek: 5, time: '20:00' }],
      price: 30,
      image: '/api/placeholder/300/200',
      rating: 4.7,
    ...
    // Saturday
    {
      ...
      maxParticipants: 20,
      currentParticipants: 12,
      schedule: [{ dayOfWeek: 6, time: '09:00' }],
      price: 25,
      image: '/api/placeholder/300/200',
      rating: 4.8,
    ...
    },
    {
      ...
      maxParticipants: 8,
      currentParticipants: 6,
      schedule: [{ dayOfWeek: 6, time: '11:00' }],
      price: 40,
      image: '/api/placeholder/300/200',
      rating: 4.9,
    ...
    // Sunday
    {
      ...
      schedule: [{ dayOfWeek: 0, time: '10:00' }],
      price: 25,
      image: '/api/placeholder/300/200',
      rating: 4.8,
